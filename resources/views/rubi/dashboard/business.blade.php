        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-8">
                            <input type="text" id="searchBusinesses" class="form-control" placeholder="Search here">
                        </div>
                        
                        <div class="col-4">
                            <button id="btnActive" class="btn btn-success">Show Active</button>
                            <button id="btnInactive" class="btn btn-danger">Show Inactive</button>
                            <button id="btnAll" class="btn btn-primary">Show All</button>
                        </div>
                    </div>
                </div>
            </div>
