	...
	<section class="subscribe-section">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-6">
					<form style="display: flex; align-items:center;" action="{{ route('newsLetterSubscribe') }}" method="post">
						@csrf
						<input type="email" name="email" class="form-control" placeholder="Enter your email" autocomplete="off">
						
						<button class="form-control" style="background:#010c29; color:white;" type="submit">
							Subscribe
						</button>
